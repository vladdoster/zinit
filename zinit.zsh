...
if [[ -z $SOURCED && ( ${+terminfo} -eq 1 && -n ${terminfo[colors]} ) || ( ${+termcap} -eq 1 && -n ${termcap[Co]} ) ]]; then
  ZINIT+=(
    ...
    col-apo     $'\e[1;38;5;45m'        col-file    $'\e[1;38;5;117m'       col-msg3    $'\e[38;5;238m'      col-quos    $'\e[1;38;5;160m'
    ...
    col-bar     $'\e[38;5;82m'          col-id-as   $'\e[1;38;5;220m'       col-num     $'\e[1;38;5;155m'    col-time    $'\e[38;5;220m'
    ...
    col-dir     $'\e[1;38;5;153m'       col-lhi     $'\e[38;5;81m'          col-pkg     $'\e[1;3;38;5;27m'   col-url     $'\e[38;5;75m'
