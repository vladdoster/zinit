...
Called by:
 ...
 zinit-install.zsh/∞zinit-file-cp-mv-operation
...
Has 205 line(s). Calls functions:
...
Has 557 line(s). Calls functions:
...
Uses feature(s): _autoload_, _compinit_, _eval_, _setopt_, _source_, _zparseopts_
